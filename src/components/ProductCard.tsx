...
//   const allSizes = getSizes(product);
//   const sizeArray = allSizes?.map((item) => item.value)
//   const variants = getVariants(product)
//   const variantType = getVariantType(variants)
...
//             width={80}
//             height={96}
//             src="https://s3-eu-west-1.amazonaws.com/commercetools-maximilian/products/072309_1_large.jpg"
...
//               <div>
//                 <h3 className="text-base font-medium ">{product.name?.en}</h3>
//                 <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">
//                   {/* <span>
//                     {variants ? variants[variantActive].name?.en : `Natural`}
//                   </span> */}
...
//                 backgroundImage: `url(${
//                   // @ts-ignore
//                   typeof variant.featuredImage === "string"
//                     ? // @ts-ignore
...
//           {sizeArray && sizeArray.length > 1 ? renderSizeList() : renderGroupButtons()}
//         </div>
