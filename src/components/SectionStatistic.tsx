...
const SectionStatistic: FC<SectionStatisticProps> = ({ className = "", facts = FOUNDER_DEMO, heading =  " 🚀 Fast Facts"}) => {
  return (
    <div className={`nc-SectionStatistic relative container lg:pt-20 ${className}`}>
      <Heading
