...
const SectionSliderLargeProduct: FC<SectionSliderLargeProductProps> = ({
  ...
  const flattenedProducts = products.map((product) => ({
    ...product,
    images: (product?.images ?? []).map((imageObject) => imageObject.src),
  }));

  return (
    <div className={`nc-SectionSliderLargeProduct container py-16 lg:pb-28 lg:pt-20  ${className}`}>
